...
const About = () => (
    <>
        <Section className={"heading-grid nav-background px-none"}>
            <div
                className={
                    "d-grid grid-columns-2 ps-gutter gap-column-7 align-items-center"
                }
            >
        ...
        <Section>
            <div
                className={"px-3 py-7 py-sm-4 ta-center mx-auto max-width-page"}
            >
